    ...
    <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.prescriptionItem}>
      <View style={styles.prescriptionContent}>
        ...
        <View style={styles.prescriptionDetails}>
          <Text style={styles.prescriptionDetail}>Date: {item.date}</Text>
          <Text style={styles.prescriptionDetail}>Doctor: {item.doctor}</Text>
          <Text style={[
            styles.prescriptionStatus,
            item.status === 'Active' && styles.statusActive,
            item.status === 'Completed' && styles.statusCompleted,
            item.status === 'Pending Review' && styles.statusPending
          ]}>
            {item.status}
          </Text>
        </View>
    ...
    <LinearGradient colors={['#000000', '#4B0082']} style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        {activeTab === "profile" && (
          <View style={styles.profileSection}>
            ...
            >
              <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.editButtonGradient}>
            ...
            <TouchableOpacity style={styles.logoutButton} onPress={handleLogout}>
              <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.logoutButtonGradient}>
        ...
        {activeTab === "family" && (
          <View style={styles.familySection}>
            ...
            <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.addMemberForm}>
              ...
              <TouchableOpacity style={styles.addButton} onPress={addFamilyMember}>
                <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.addButtonGradient}>
            ...
            {familyMembers.length > 0 ? (
              <View style={styles.tableContainer}>
                {/* Table Header */}
                <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.tableHeader}>
        ...
        {activeTab === "prescriptions" && (
          <View style={styles.prescriptionsSection}>
            ...
            <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.prescriptionCard}>
              ...
              <TouchableOpacity style={styles.uploadButton} onPress={uploadPrescription}>
      ...
      >
        <View style={styles.modalContainer}>
          <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.modalContent}>
            ...
            <View style={styles.modalButtons}>
              ...
              >
                <LinearGradient colors={['#8A2BE2', '#FF00FF']} style={styles.saveButtonGradient}>
